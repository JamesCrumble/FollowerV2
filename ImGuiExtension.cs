...
namespace FollowerV2
{
    public class ImGuiExtension
    {
        ...
        {
            var refValue = value;
            ImGui.SliderFloat(labelString, ref refValue, minValue, maxValue, "%.00f", (ImGuiSliderFlags)1f);
            return refValue;
        }
        ...
        {
            var refValue = value;
            ImGui.SliderFloat(labelString, ref refValue, minValue, maxValue, "%.00f", (ImGuiSliderFlags)power);
            return refValue;
        }
        ...
        {
            var refValue = value;
            ImGui.SliderFloat(labelString, ref refValue, minValue, maxValue, $"{sliderString}: {value}", (ImGuiSliderFlags)1f);
            return refValue;
        }
        ...
        {
            var refValue = value;
            ImGui.SliderFloat(labelString, ref refValue, minValue, maxValue, $"{sliderString}: {value}", (ImGuiSliderFlags)power);
            return refValue;
        }
        ...
        {
            var refValue = setting.Value;
            ImGui.SliderFloat(labelString, ref refValue, setting.Min, setting.Max, "%.00f", (ImGuiSliderFlags)1f);
            return refValue;
        }
        ...
        {
            var refValue = setting.Value;
            ImGui.SliderFloat(labelString, ref refValue, setting.Min, setting.Max, "%.00f", (ImGuiSliderFlags)power);
            return refValue;
        }
