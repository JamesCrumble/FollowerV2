...
namespace FollowerV2
{
    public class FollowerV2Settings : ISettings
    {
        ...
        private void ResetAllSettingsToDefaults()
        {
            ...
            FollowerModeSettings.FollowingDistanceCancelling.Value = 200;
            ...
            if (Profiles.Value == ProfilesEnum.Follower)
                if (ImGui.TreeNodeEx("Follower Mode Settings", collapsingHeaderFlags))
                {
                    ...
                    if (FollowerModeSettings.FollowerModes.Value == FollowerNetworkActivityModeEnum.Local)
                    {
                        ...
                        FollowerModeSettings.FollowingDistanceCancelling.Value = ImGuiExtension.IntSlider("Following distance canceling", FollowerModeSettings.FollowingDistanceCancelling);
                    }
    ...
    public class FollowerModeSetting
    {
        ...
        public RangeNode<int> FollowingDistanceCancelling { get; set; } = new RangeNode<int>(200, 31, 1000);
